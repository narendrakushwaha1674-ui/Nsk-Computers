(function () {
  ...
  function renderAdminLogin() {
    app.innerHTML = header("") + '<main class="login-shell"><div class="landing-wrap"><section class="hero-panel"><h1>Computer Mcq NSK SIR</h1><p>Daily 100 MCQ paper practice, 60 minute timer, instant result PDF, secure student login and admin control in one professional website.</p><div class="hero-stats"><div class="hero-stat"><b>100</b><span>Daily Questions</span></div><div class="hero-stat"><b>60m</b><span>Paper Timer</span></div><div class="hero-stat"><b>PDF</b><span>Result PDF</span></div></div></section><section class="login-card"><div class="brand" style="font-size:34px;margin-bottom:22px;">Computer By Nsk Sir</div><h1>Admin Login</h1><label class="field">Admin ID<input id="adminId" autocomplete="username"></label><label class="field">Password<input id="adminPass" type="password" autocomplete="current-password"></label><div class="error" id="loginError"></div><button class="primary wide" id="adminLoginBtn">Login</button><a class="link-button" id="studentLoginLink">Student ID Login</a></section></div></main>';
