...
if (clearNotesBtn) {
  ...
  function adminStudents() {
    ...
    document.getElementById(
      ...
      '<button class="primary" id="addStudent">Add Student</button>' +
      "</div>" +
  ...
  function showStudentModal() {
    openModal(
      ...
      '<p class="muted">Yahan student ki ID aur password sirf admin banayega. Student wahi ID/password use karke login karega.</p>' +

      '<div class="form-grid">' +

      '<label class="field">Student Name<input id="newName"></label>' +

      '<label class="field">Email<input id="newEmail"></label>' +

      '<label class="field">Mobile<input id="newMobile"></label>' +

      '<label class="field">User ID<input id="newUserId" placeholder="Generate karein ya apni ID likhein"></label>' +

      '<label class="field">Password<input id="newPassword" placeholder="Generate karein ya apna password likhein"></label>' +

      '<div class="span-2">' +

      '<button class="ghost mini-btn" id="generateUserId">Generate ID</button> ' +

      '<button class="ghost mini-btn" id="generatePassword">Generate Password</button>' +

      "</div>" +

      "</div>" +

      '<button class="primary" id="saveStudent">Save Student</button>'
    );
    ...
    document.getElementById(
      ...
      if (
        ...
        alert(
          "Student ID aur password zaroor dalein ya Generate ID/Password dabayein."
        );
        return;
      }
  ...
  function adminGenerateId() {
    document.getElementById(
      ...
      "<h1>ID/password generate karein</h1>" +

      '<div class="form-grid">' +

      '<label class="field">Student Name<input id="genName" placeholder="Example: Rahul Kumar"></label>' +

      '<label class="field">Course<select id="genCourse">' +

      "<option>All Computer Courses</option>" +
      ...
      '<label class="field">City<input id="genCity" placeholder="Example: Indergarh"></label>' +

      '<label class="field">Mobile Number<input id="genMobile" placeholder="Example: 9876543210"></label>' +

      '<label class="field span-2">Gmail ID<input id="genEmail" placeholder="Example: student@gmail.com"></label>' +

      "</div>" +

      '<button class="primary" id="generateStudentCard">ID generate karein</button>' +

      '<div id="generatedCardArea"></div>' +
    ...
    document.getElementById(
      ...
      if (
        ...
        alert(
          "Student Name, Mobile Number aur Gmail ID zaroor dalein."
        );
        return;
      }
      ...
      /*
       * Current backend ke bina generated student
       * local state me save hota hai.
       *
       * Existing login API me jo accounts Google
       * Sheet me hain unka login online verify hoga.
       */
      state.students.push(
        student
      );
  ...
  function generatedIdCard(
    ...
    return (
      ...
      "<h2>Computer By Nsk Sir</h2>" +
      "<p>Authorized institute login</p>" +
      "</div>" +
      ...
      '<div class="id-row"><span>ID</span><b>' +
      esc(student.userId) +
      "</b></div>" +

      '<div class="id-row"><span>Password</span><b>' +
      esc(student.password) +
      "</b></div>" +

      '<div class="id-row"><span>Course</span><b>' +
      esc(
        student.course ||
          "All Computer Courses"
      ) +
      ...
      '<div class="id-row"><span>Director</span><b>Director - Nsk Kushwaha (NSK)</b></div>' +

      '<div class="id-row"><span>Contact</span><b>9179424002</b></div>' +

      '<div class="id-row"><span>Email</span><b>Narendrakushwaha1674@gmail.com</b></div>' +

      '<div class="id-actions">' +

      '<button class="ghost" id="copyGenerated">Copy</button>' +

      '<button class="ghost" id="printGenerated">Print</button>' +

      '<button class="ghost danger-text" id="deleteGenerated">Delete</button>' +
